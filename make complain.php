...
<h2 style="text-align: center">Have any complain? Fill up the box & send us.</h2><br>

  <form action="make complain2.php" method="post" name="myForm" onsubmit="return validateForm()">
    <div class="input-field2">
      <label class="input-field3">Your Name </label><br>
    ...
    <label class="input-field5"> Your Complain</label><br>
    <textarea name="msg" class="contact-in-textarea" placeholder="Message..." required></textarea>
...
<div class="column">
  <img src="seat1.jpg" height="610" width="670">
